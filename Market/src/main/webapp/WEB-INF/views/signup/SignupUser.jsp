        ...
        <div>
            <div class="signup2">
                <form name="f" method="post" action="/signup/insertUserInfo" onsubmit="return doRegUserCheck(this);">
                    이메일, 패스워드, 닉네임, 성별, 나이, 비건여부, 비건종류 <br>
                    <input type="email" name="email_user" placeholder="E-mail" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search Keyword'" required><br><br>
                    <input type="password" name="pwd_user" placeholder="password" ><br><br>
                    <input type="password" name="pwd2_user" placeholder="confirm password" ><br><br>
                    <input type="text" name="name_user" placeholder="name"><br><br>
                    <input type="radio" name="gender" value="man"> 남 &nbsp;&nbsp;&nbsp;
                    <input type="radio" name="gender" value="woman"> 여<br><br>
                    <input type="text" name="age_user" placeholder="age"> <br><br>
